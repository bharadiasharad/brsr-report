...
const SectionB = () => {
  ...
  const getHeadingData = (definationId) => {
    switch (definationId) {
      case SectionBHeading[0].definationId:
        return <H1  />;
      case SectionBHeading[1].definationId:
        return <H2  />;
      case SectionBHeading[2].definationId:
        return <H3  />;
      case SectionBHeading[3].definationId:
        return <H4  />;
      case SectionBHeading[4].definationId:
        return <H5 />;
      case SectionBHeading[5].definationId:
        return <H6  />;
      case SectionBHeading[6].definationId:
        return <H7  />;
      default:
        return <H1  />;
    }
