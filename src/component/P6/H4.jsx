...
import { P6_4 } from "./Type.ts";

const H4 = (props) => {
  const [currentYearData, setCurrentYearData] = useState(new P6_4({}));
                ...
                <Col style={{ paddingTop: "10px" }} offset={2} span={4}>
                  <Select
                    ...
                    onChange={(e) => {
                      setCurrentYearData({
                        ...currentYearData,
                        isZeroLiquidDischarge: e.target.value,
                      });
                    }}
                    value={currentYearData.isZeroLiquidDischarge}
                  >
