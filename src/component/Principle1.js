...
import H8 from './P1/H8';
import H9 from './P1/H9';
...
const Principle1 = () => {
  ...
  const getHeadingData = (definationId) => {
    switch (definationId) {
      case P1Heading[0].definationId:
        return <H1  />;
      case P1Heading[1].definationId:
        return <H2  />;
      case P1Heading[2].definationId:
        return <H3  />;
      case P1Heading[3].definationId:
        return <H4  />;
      case P1Heading[4].definationId:
        return <H5 />;
      case P1Heading[5].definationId:
        return <H6  />;
      case P1Heading[6].definationId:
        return <H7  />;
      case P1Heading[7].definationId:
        return <H8  />;
      case P1Heading[8].definationId:
        return <H9  />;
      default:
        return <H1  />;
    }
