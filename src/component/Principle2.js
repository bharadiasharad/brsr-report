...
import H5 from './P2/H5';
import H6 from './P2/H6';
import H7 from './P2/H7';
import H8 from './P2/H8';
import H9 from './P2/H9';
...
const Principle2 = () => {
  ...
  const getHeadingData = (definationId) => {
    switch (definationId) {
      case P2Heading[0].definationId:
        return <H1  />;
      case P2Heading[1].definationId:
        return <H2  />;
      case P2Heading[2].definationId:
        return <H3  />;
      case P2Heading[3].definationId:
        return <H4  />;
      case P2Heading[4].definationId:
        return <H5 />;
      case P2Heading[5].definationId:
        return <H6  />;
      case P2Heading[6].definationId:
        return <H7  />;
      case P2Heading[7].definationId:
        return <H8  />;
      case P2Heading[8].definationId:
        return <H9  />;
      default:
        return <H1  />;
    }
