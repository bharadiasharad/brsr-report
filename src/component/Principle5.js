...
import H11 from './P5/H11';
import H12 from './P5/H12';
import H13 from './P5/H13';
import H14 from './P5/H14';
import H15 from './P5/H15';
...
const Principle5 = () => {
  ...
  const getHeadingData = (definationId) => {
    switch (definationId) {
      case P5Heading[0].definationId:
        return <H1 />;
      case P5Heading[1].definationId:
        return <H2 />;
      case P5Heading[2].definationId:
        return <H3 />;
      case P5Heading[3].definationId:
        return <H4 />;
      case P5Heading[4].definationId:
        return <H5 />;
      case P5Heading[5].definationId:
        return <H6 />;
      case P5Heading[6].definationId:
        return <H7 />;
      case P5Heading[7].definationId:
        return <H8 />;
      case P5Heading[8].definationId:
        return <H9 />;
      case P5Heading[9].definationId:
        return <H10 />;
      case P5Heading[10].definationId:
        return <H11 />;
      case P5Heading[11].definationId:
        return <H12 />;
      case P5Heading[12].definationId:
        return <H13 />;
      case P5Heading[13].definationId:
        return <H14 />;
      case P5Heading[14].definationId:
        return <H15 />;
      default:
        return <H1 />;
    }
