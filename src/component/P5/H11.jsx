...
import { P5_11 } from "./Type.ts";

const H11 = (props) => {
  const [currentYearData, setCurrentYearData] = useState(new P5_11({}));
            ...
            <Col style={{ margin: "5px" }} span={20}>
              <Row>
                <Col style={{ padding: "6px" }} span={10}>
                  <p>
                    {" "}
                    Details of a business process being modified / introduced as
                ...
                <Col style={{ paddingTop: "10px" }} offset={2} span={12}>
                  <TextArea
                    ...
                    value={currentYearData.modification}
                  />
                </Col>
              </Row>
            </Col>
